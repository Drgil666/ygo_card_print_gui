...
public class YuGiOhSeleniumUtil {
    ...
    public static final String URL = "https://ygo.ygosgs.com/#/yugioh";
    ...
    public static final String CARD_NAME_XPATH = "/html/body/div[1]/div/section/main/div/div/div[2]/div[1]/div[1]/div/div/div[2]/form/div[3]/div[2]/div/div/div/input";
    ...
    public static final String JAPANESE_CARD = "/html/body/div[2]/div[2]/div/div/div[1]/ul/li[3]";
    public static final String CHINESE_CARD = "/html/body/div[2]/div[2]/div/div/div[1]/ul/li[1]";
    public static final String CONFIRM_BUTTON = "/html/body/div[3]/div/div/div[3]/button";
    ...
    public static final String CARD_CODE = "/html/body/div[1]/div/section/main/div/div/div[2]/div[1]/div[1]/div/div/div[2]/form/div[19]/div[2]/div/div[1]/div/input";
    ...
    public static final String CARD_CODE_CONFIRM = "/html/body/div[1]/div/section/main/div/div/div[2]/div[1]/div[1]/div/div/div[2]/form/div[19]/div[2]/div/div[2]/div/button[1]";
    ...
    public static String getImageByCardCode(String code) throws InterruptedException, IOException {
        driver.navigate().refresh();
        Thread.sleep(10000);
        WebElement confirmButton=driver.findElement(By.xpath(CONFIRM_BUTTON));
        confirmButton.click();
        ...
        WebElement downloadButton = driver.findElement(By.xpath(DOWNLOAD_BUTTON));
        downloadButton.click();
        String cardName=getCardName(code);
        Main.addLine("下载");
        Thread.sleep(10000);
        Main.addLine("卡名：" + cardName);
        return cardName;
    }
    public static String getCardName(String cardCode) throws IOException {
        String url="https://api.ygosgs.com/api/yugioh/card/"+cardCode+"?lang=sc&source=";
        String object=OkHttpUtil.sendGetRequest(url);
        Card card = JSON.parseObject(object, Card.class);
